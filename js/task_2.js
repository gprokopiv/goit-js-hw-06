...
//const eyeColor = users.filter(users => users.eyeColor);
...
const users = [
  ...
  //const getUsersWithEyeColor = function(array, color) => array.filter(({eyeColor}) => eyeColor === color);

    
  const result = (array, color) => array.filter( ({eyeColor}) => eyeColor === color );
  console.log(result(users, 'blue'));


const getUsersWithEyeColor = (array, color) => array.filter(({eyeColor}) => eyeColor === color); 
 console.log(getUsersWithEyeColor(users, 'blue'));
 // const eyeColor = array.filter(users => users.eyeColor);
